...
EventDispatcher.prototype.emit = function (type) {
  ...
  for (
    var _len = arguments.length,
      argument = Array(_len > 1 ? _len - 1 : 0),
      _key = 1;
    _key < _len;
    _key++
  ) {
...
var InteractionManager = (function (_EventDispatcher) {
  ...
  function InteractionManager(renderer, scene, camera, options) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (
        InteractionManager.__proto__ ||
        Object.getPrototypeOf(InteractionManager)
      ).call(this)
    );
  ...
  createClass(InteractionManager, [
    ...
    },
    {
      ...
      value: function processInteractive(
        interactionEvent,
        displayObject,
        func,
        hitTest,
        ...
        if (displayObject.interactiveChildren && displayObject.children) {
          ...
          for (var i = children.length - 1; i >= 0; i--) {
            ...
            var childHit = this.processInteractive(
              interactionEvent,
              child,
              func,
              hitTest,
    ...
    },
    {
      ...
      value: function processPointerOverOut(
        interactionEvent,
        displayObject,
        hit
      ) {
        ...
        if (hit && !trackingData) {
          trackingData = displayObject.trackedPointers[
            id
    ...
    },
    {
      ...
      value: function configureInteractionEventForDOMEvent(
        interactionEvent,
        pointerEvent,
        interactionData
      ) {
...
var InteractionLayer = (function (_EventDispatcher) {
  ...
  function InteractionLayer(renderer, options) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (
        InteractionLayer.__proto__ || Object.getPrototypeOf(InteractionLayer)
      ).call(this)
    );
...
var Ticker = (function (_EventDispatcher) {
  ...
  function Ticker() {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Ticker.__proto__ || Object.getPrototypeOf(Ticker)).call(this)
    );
...
var Interaction = (function (_InteractionManager) {
  ...
  function Interaction(renderer, scene, camera, options) {
    ...
    var _this = possibleConstructorReturn(
      this,
      (Interaction.__proto__ || Object.getPrototypeOf(Interaction)).call(
        this,
        renderer,
        scene,
        camera,
